...
export default function FormationDetailsPage() {
  ...
  const { selectedFormation } = useFormations()
                      ...
                      <div className="row justify-content-center">
                        <div className="col-xl-4 col-lg-5 col-md-6">
                          <div className="preview_video">
                            <a href="##" className="fcrse_img" data-toggle="modal" data-target="#videoModal">
                              <img src={selectedFormation.image.data[0].attributes.formats.small.url} alt />
                              <div className="course-overlay">
                                <div className="badge_seller">{selectedFormation.avec_certificat ? "Certification" : "Sans Certification"}</div>
                                <span className="play_btn1"><i className="uil uil-play" /></span>
                                <span className="_215b02">{selectedFormation.lieu}</span>
                              </div>
                            </a>
                          </div>
                        </div>
                        <div className="col-xl-8 col-lg-7 col-md-6">
                          <div className="_215b03">
                            <h2>{selectedFormation.Theme}</h2>
                            <span className="_215b04" style={{ textAlign: "justify" }}>{selectedFormation.description.slice(0, 250)}...</span>
                          </div>
                          <div className="_215b05">
                            <div className="crse_reviews mr-2">
                              <i className="uil uil-star" />{selectedFormation.prix_formation}
                            </div>
                            FCFA
                          </div>
                          <div className="_215b06">
                            <div className="_215b07">
                              ...
                              {selectedFormation.langue}
                            </div>
                          </div>
                          <div className="_215b05">
                            Denière modification le {selectedFormation.updatedAt.slice(0, 10)}
                          </div>
                          ...
                          <div className="user_img5">
                            <a href="#">
                              <Avatar style={{ backgroundColor: 'aquamarine' }}>
                                <strong style={{ color: "#000" }}>{selectedFormation.formateur.data.attributes.Nom.charAt(0)}</strong>
                              </Avatar>
                            </a>
                          </div>
                          <div className="user_cntnt" style={{ margin: '0px 10px' }}>
                            <a href="#" className="_df7852">
                              {selectedFormation.formateur.data.attributes.Nom} {selectedFormation.formateur.data.attributes.Prenoms}
                            </a>
                            <button className="subscribe-btn"> {selectedFormation.formateur.data.attributes.Email}</button>
                          </div>
                        </div>
                      </div>
